import {
  ...
  import { LichSan } from '../../lich-san/entities/lich-san.entity';
    import { VeDienTu } from '../../ve-dien-tu/entities/ve-dien-tu.entity';
  ...
  export class DatSan {
    ...
    @ApiPropertyOptional({ description: 'Trạng thái đặt sân', example: 'Chờ duyệt' })
    ...
    @OneToOne(() => VeDienTu, (ve) => ve.datSan)
    veDienTu: VeDienTu;
  }