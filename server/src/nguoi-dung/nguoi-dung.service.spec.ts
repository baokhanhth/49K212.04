...
describe("NguoiDungService", () => {
  ...
  describe("dangKyTaiKhoan", () => {
    ...
    it("should throw error when msv contains spaces", async () => {
      await expect(
    ...
    it("should throw error when msv contains letters", async () => {
      await expect(
        service.dangKyTaiKhoan({
          ...validDto,
          msv: "23112152ABCD",
    ...
    it("should throw error when hoTen contains special characters", async () => {
      await expect(
        service.dangKyTaiKhoan({
          ...validDto,
          hoTen: "Nguyen@Van#A",
    ...
    it("should throw error when emailCaNhan is invalid", async () => {
      await expect(
        service.dangKyTaiKhoan({
          ...validDto,
          emailCaNhan: "abc@@gmail",
        })
      ).rejects.toThrow();
    });
    ...
    it("should throw BadRequestException when emailTruong already exists", async () => {
      ...
      await expect(service.dangKyTaiKhoan(validDto)).rejects.toThrow(
        "Email đã tồn tại"
      );
    });
